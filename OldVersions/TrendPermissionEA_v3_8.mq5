//+------------------------------------------------------------------+
//|                                        TrendPermissionEA_v3_8.mq5 |
//|                        Layer 0 Risk Governor + Execution Layer    |
//|                                                       Version 3.8 |
//+------------------------------------------------------------------+
#property copyright "TrendPermission"
#property version   "3.8"
#property description "Trend Gating Upgrade: Structural Body Clearance + ATR-Normalized Slope"
...
int OnInit()
{
    ...
    Print("==============================================");
    Print("TrendPermissionEA_v3_8 initialized");
    Print("Symbol: ", _Symbol, " | Timeframe: M1");
    Print("----------------------------------------------");
    Print("LAYER 0 v3.8 - TREND GATING UPGRADE");
    Print("NEW: Structural Body Clearance Filter");
    Print("NEW: ATR-Normalized Slope Filter (threshold: ", MIN_SLOPE_STRENGTH, ")");
    Print("----------------------------------------------");
...
bool OpenBuyTrade()
{
    ...
    if(trade.Buy(LotSize, _Symbol, ask, 0, 0, "TrendPerm_v3_8_BUY"))
        return true;
...
bool OpenSellTrade()
{
    ...
    if(trade.Sell(LotSize, _Symbol, bid, 0, 0, "TrendPerm_v3_8_SELL"))
        return true;
...
void CreatePanel()
{
    ...
    CreateLabel(PREFIX + "Version", PANEL_X + 270, y + 14, "v3.8", C'100,180,255', 12, PANEL_FONT_BOLD);
...
void OnDeinit(const int reason)
{
    DeletePanel();
    Comment("");
    Print("TrendPermissionEA_v3_8 deinitialized. Reason: ", reason);
